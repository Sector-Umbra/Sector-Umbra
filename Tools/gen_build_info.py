...
FORK_ID = "sectorumbra"
BUILD_URL = f"https://sector-umbra.net/static/builds/{{FORK_VERSION}}/{FILE}"
MANIFEST_URL = f"https://sector-umbra.net/cdn/version/{{FORK_VERSION}}/manifest"
MANIFEST_DOWNLOAD_URL = f"https://sector-umbra.net/cdn/version/{{FORK_VERSION}}/download"
