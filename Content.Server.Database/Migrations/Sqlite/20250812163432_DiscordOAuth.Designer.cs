...
namespace Content.Server.Database.Migrations.Sqlite
{
    ...
    [Migration("20250812163432_DiscordOAuth")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Content.Server.Database.DiscordOAuthToken", b =>
                {
                    b.Property<Guid>("PlayerUserId")
                        .HasColumnType("TEXT")
                        .HasColumnName("player_user_id");
            ...
            modelBuilder.Entity("Content.Server.Database.DiscordOAuthToken", b =>
                {
                    b.HasOne("Content.Server.Database.Player", "Player")
                        ...
                        .HasForeignKey("Content.Server.Database.DiscordOAuthToken", "PlayerUserId")
                        .HasPrincipalKey("Content.Server.Database.Player", "UserId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired()
                        .HasConstraintName("FK_oauth_tokens_player_player_user_id");
