using Content.Shared._RMC.Cassette;
using Content.Shared._RMC.CCVar;
...
namespace Content.Client._RMC.Cassette;
...
public sealed class CassetteSystem : SharedCassetteSystem
{
    ...
    protected override async void ChooseCustomTrack(Entity<CassetteTapeComponent> tape)
    {
        try
        {
            ...
            var name = $"/Audio/_RMC14/_CustomCassetteUploads/upload_{_names.Count}.ogg"; // Change Path
