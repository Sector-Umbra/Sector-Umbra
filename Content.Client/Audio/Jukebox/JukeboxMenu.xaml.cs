...
public sealed partial class JukeboxMenu : FancyWindow
{
    ...
    public void Populate(IEnumerable<JukeboxPrototype> jukeboxProtos)
    {
        ...
        var jukeboxProtoList = jukeboxProtos.ToList(); // Umbra: Sort the jukebox list
        jukeboxProtoList.Sort((p1, p2) => p1.Name.CompareTo(p2.Name)); // Umbra

        foreach (var entry in jukeboxProtoList) // Umbra: jukeboxProtoList<jukeboxProtos
        {
